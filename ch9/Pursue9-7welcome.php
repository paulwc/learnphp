<?php // Pursue 9.7welcome - welcome.php #2
...
// Print a greeting:
print "<h2>Welcome to the J.D. Salinger Fan Club {$_SESSION['name']}!</h2>";
...
// Make a logout link:
print '<p><a href="Pursue9-7logout.php">Click here to logout.</a></p>';

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['email']) || (substr_count($_POST['email'], '@') != 1) || (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)==FALSE) ) {
        $problem = TRUE;
    ...
    if (!$problem) { // If there weren't any problems...
        ...
        // send the email
        $body = "Thank you for registering with the J.D. Salinger fan club! Your password is 
                    '{$_POST['password1']}'.";
